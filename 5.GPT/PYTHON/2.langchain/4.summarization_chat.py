...
llm = ChatOpenAI(model="gpt-4o", temperature=0.5) # 요약이 목적이니 정확하게

chain = prompt | llm | RunnableLambda(lambda x: {"summary":x.content.strip()}) # 주의 (기존 x에서 chat 모드에서는 x.content에 담겨서 온다)
