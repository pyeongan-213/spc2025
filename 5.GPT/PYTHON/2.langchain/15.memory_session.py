...
print(chain_with_memory.invoke({"input": "근데, 우리 무슨 이야기를 하고 있었지?"}, config={"configurable": {"session_id": session_id1}}))
print(chain_with_memory.invoke({"input": "근데, 우리 무슨 이야기를 하고 있었지?"}, config={"configurable": {"session_id": session_id2}}))