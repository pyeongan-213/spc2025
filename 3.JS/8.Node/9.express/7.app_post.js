...
// app.use(bodyParser.json()); // 이건 옛날 방식임 express 4.16 이후부터는 더이상 안써도 됨
...
app.post('/user', (req, res) => {
    console.log('사용자 생성 요청:', req.body); // curl 127.0.0.1:3000/user -X POST -H "Content-Type: application/json" -d "{\"name\": \"john\"}"
